...
class NilaiController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if (auth()->user()->role == 'aslab')
            return view('role.aslab.nilai-detail', [
                'mahasiswa' => $mahasiswa,
                'kelas' => $kelas,
                'myThis' => $this
                // 'nilai' => $nilai
    ...
    // public function simpan_nilai_dosbim(Request $request)
    // {
    //     $id_mhs = $request->get('id_mahasiswa');
    //     // $id_kls = $request->get('id_kelas');
    //     $nilai_dosbim = $request->get('nilai_dosen');
    //     $tp1 = $request->get('tp1');
    //     $tp2 = $request->get('tp2');
    //     $tp3 = $request->get('tp3');
    //     $tp4 = $request->get('tp4');
    ...
    //         $simpan->id_mahasiswa = $id_mhs[$i];
    //         // $simpan->id_kelas = $id_kls[$i];
    //         $simpan->nilai_dosen = $nilai_dosbim[$i];
    //         $simpan->nilai_p1 = $nilai_p1;
    //         $simpan->nilai_p2 = $nilai_p2;
    //         $simpan->nilai_p3 = $nilai_p3;
    //         $simpan->nilai_p4 = $nilai_p4;
