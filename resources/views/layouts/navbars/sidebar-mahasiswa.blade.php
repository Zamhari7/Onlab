    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="collapse-materi">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('video-mahasiswa.index') }}">
                                    {{ __('Video') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('modul-mahasiswa.index') }}">
                                    {{ __('Modul') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('artikel-mahasiswa.index') }}">
                                    {{ __('Artikel') }}
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('tugas-mahasiswa.index') }}">
