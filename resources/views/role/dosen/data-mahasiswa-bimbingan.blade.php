                    ...
                    <div class="row align-items-center pt-3">
                        <div class="col-lg-6 col-5">
                            <div class="card-header border-0">
                                <h3 class="mb-0">Data Mahasiswa Bimbingan</h3>
                            </div>
                        </div>
                        {{-- <div class="col-lg-6 col-5 text-right">
                            <a class="btn btn-primary mr-4" href="{{ route('mahasiswa.create') }}">
                        ...
                        <table id="print" data-toggle="table" data-pagination="true" data-search="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="price">Dosen Pembimbing</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($mahasiswa as $mahasiswa)
                                    <tr>
                                        ...
                                        <td>{{ $mahasiswa->dosbim->nama_dosbim }}</td>
                                        {{-- <td class="row">
                                            <a href="{{ url('mahasiswa/' . $mahasiswa->id . '/edit') }}"
                                                class="btn btn-success">
                                                <i class="fas fa-pen"></i></a>
                                            <form action="{{ url('mahasiswa/' . $mahasiswa->nbi) }}" method="post">
                                                @csrf
                                                @method('delete')
