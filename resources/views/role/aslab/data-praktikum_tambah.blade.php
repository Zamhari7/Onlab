            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="mb-0">{{ __('Tambah data praktikum') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('praktikum.store') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('nama_prak') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-nama_prak">{{ __('Nama Praktikum') }}</label>
