    ...
    <div class="container-fluid mt--6">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('tugas.update', $tugas->id) }}" autocomplete="off"
                        ...
                        <div class="pl-lg-4">
                            {{-- <div class="form-group{{ $errors->has('id_kelas') ? ' has-danger' : '' }}">
                                ...
                                <select name="id_kelas" id="input-id_kelas"
                                    ...
                                    placeholder="" value="{{ $tugas->kelas->id_kelas }}" required>
                            ...
                            <div class="form-group{{ $errors->has('file') ? ' has-danger' : '' }}">
                                ...
                                <input type="file" name="file" id="input-file" enctype="multipart/form-data"
                                    class="form-control form-control-alternative{{ $errors->has('file') ? ' is-invalid' : '' }}"
                                    placeholder="" value="{{ $tugas->file }}">{{ $tugas->nama_file }}
