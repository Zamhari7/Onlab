            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="mb-0">{{ __('Tambah artikel') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('artikel.store') }}" autocomplete="off"
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('nama_file') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-nama_file">{{ __('Judul artikel') }}</label>
                            ...
                            <div class="form-group{{ $errors->has('file') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="file" id="input-file"
