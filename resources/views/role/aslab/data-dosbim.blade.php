                    ...
                    <div class="col-lg-6 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Dosbim</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center pt-3">
                        <div class="col-lg-6 col-5">
                            <div class="card-header border-0">
                                <h3 class="mb-0">Data Dosen Pembimbing</h3>
                            </div>
                        </div>
                        <div class="col-lg-6 col-5 text-right">
                            <a class="btn btn-primary mr-4" href="{{ route('dosbim.create') }}">
                        ...
                        <table id="print" data-toggle="table" data-pagination="true" data-search="true">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th data-field="name">Kode Dosen</th> --}}
                                    <th data-field="price">Nidn</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($dosbim as $dosbim)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td>{{ $dosbim->nidn }}</td>
                                        <td>{{ $dosbim->nama_dosbim }}</td>
                                        <td>{{ $dosbim->no_hp }}</td>
                                        <td class="row">
                                            <a href="{{ url('dosbim/' . $dosbim->id . '/edit') }}"
                                                class="btn btn-success">
                                                <i class="fas fa-pen"></i></a>
                                            <form action="{{ url('dosbim/' . $dosbim->nidn) }}" method="post">
                                                @csrf
                                                @method('delete')
